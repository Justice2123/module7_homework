...
function Lighting (name, manufacturer, powers, led){
    this.name= name,
    ...
    this.powers = function(){console.log(`Electricity consumption of the ${this.name} is ${powers} W.`)}
}
  
const lamp = new Lighting('lamp', 'IKEA');
const powers  = new Lighting('lamp','', 50);
